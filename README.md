...
The system uses a Large Language Model (LLM) with advanced prompt engineering techniques (Role-Based Prompting + Few-Shot Learning) to ensure high-quality, structured, and contextually accurate outputs.
...
```
git clone https://github.com/pratheeksha-s-devadiga/email-generator-assistant.git
...
- Advanced tone detection using NLP models
